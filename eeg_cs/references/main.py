...
def plot_results(x, x_cs, x_under, alpha_true, alpha_cs, alpha_under, title):
    ...
    plt.stem(alpha_under, linefmt='r:', markerfmt='ro', basefmt=' ', label='Under-sampled')
...
# Plot for Lasso
plot_results(x, x_cs_lasso, x_under_lasso, alpha_true, alpha_cs_lasso, alpha_under_lasso, "Lasso")

# Plot for CoSaMP
plot_results(x, x_cs_cosamp, x_under_cosamp, alpha_true, alpha_cs_cosamp, alpha_under_cosamp, "CoSaMP")

# Plot for Basis Pursuit
plot_results(x, x_cs_bp, x_under_bp, alpha_true, alpha_cs_bp, alpha_under_bp, "Basis Pursuit")