...
class CompressedSensing:
    ...
    @staticmethod
    def _pdr(X: npt.NDArray[np.float64], X_hat: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]:
        """
    ...
    @staticmethod
    def _nmse(X: npt.NDArray[np.float64], X_hat: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]:
        """
    ...
    @staticmethod
    def _sndr(X: npt.NDArray[np.float64], X_hat: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]:
        """
